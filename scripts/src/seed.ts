...
async function main() {
  ...
  await db.insert(schema.budgetEntriesTable).values([
    { projectId: proj("FrostLine WMS Implementation").id,         type: "SOW",        amount: "1250000", description: "Original signed contract value",                       enteredByUserId: u("Marcus Webb").id },
    { projectId: proj("FrostLine WMS Implementation").id,         type: "Adjustment", amount: "75000",   description: "Change order #1 – additional DC configuration scope", enteredByUserId: u("Marcus Webb").id },
    { projectId: proj("VeloFreight TMS Rollout – Phase 1").id,    type: "SOW",        amount: "780000",  description: "Phase 1 SOW value",                                    enteredByUserId: u("Marcus Webb").id },
    { projectId: proj("VeloFreight TMS Rollout – Phase 1").id,    type: "Adjustment", amount: "-40000",  description: "Scope reduction – postponed carrier rating module",    enteredByUserId: u("Marcus Webb").id },
    { projectId: proj("Oracle WMS Cloud Migration").id,           type: "SOW",        amount: "340000",  description: "Original fixed-fee value",                             enteredByUserId: u("Priya Nair").id },
    { projectId: proj("Route Optimisation Engine Deployment").id, type: "SOW",        amount: "490000",  description: "Final contract value",                                  enteredByUserId: u("Sophie Laurent").id },
    { projectId: proj("HarbourLink EDI Integration").id,          type: "SOW",        amount: "320000",  description: "T&M cap per MSA",                                       enteredByUserId: u("Daniel Osei").id },
    { projectId: proj("Fleet Telemetry MVP").id,                  type: "SOW",        amount: "220000",  description: "MVP fixed fee per draft SOW",                          enteredByUserId: u("Tom Bridges").id },
  ]);

  // ─── Revenue Entries ──────────────────────────────────────────────────────
  await db.insert(schema.revenueEntriesTable).values([
    { projectId: proj("FrostLine WMS Implementation").id,         month: "2024-11", recognisedAmount: "50000",  method: "percentage_complete", notes: "Month 1 recognition" },
    { projectId: proj("FrostLine WMS Implementation").id,         month: "2024-12", recognisedAmount: "90000",  method: "percentage_complete", notes: "Blueprint delivery" },
    { projectId: proj("FrostLine WMS Implementation").id,         month: "2025-01", recognisedAmount: "85000",  method: "percentage_complete" },
    { projectId: proj("FrostLine WMS Implementation").id,         month: "2025-02", recognisedAmount: "95000",  method: "percentage_complete" },
    { projectId: proj("FrostLine WMS Implementation").id,         month: "2025-03", recognisedAmount: "100000", method: "percentage_complete" },
    { projectId: proj("VeloFreight TMS Rollout – Phase 1").id,    month: "2025-01", recognisedAmount: "72000",  method: "time_and_materials" },
    { projectId: proj("VeloFreight TMS Rollout – Phase 1").id,    month: "2025-02", recognisedAmount: "84000",  method: "time_and_materials" },
    { projectId: proj("VeloFreight TMS Rollout – Phase 1").id,    month: "2025-03", recognisedAmount: "95000",  method: "time_and_materials" },
    { projectId: proj("VeloFreight TMS Rollout – Phase 1").id,    month: "2025-04", recognisedAmount: "103000", method: "time_and_materials" },
    { projectId: proj("Oracle WMS Cloud Migration").id,           month: "2025-02", recognisedAmount: "55000",  method: "milestone" },
    { projectId: proj("Oracle WMS Cloud Migration").id,           month: "2025-03", recognisedAmount: "30000",  method: "milestone" },
    { projectId: proj("Oracle WMS Cloud Migration").id,           month: "2025-04", recognisedAmount: "65000",  method: "milestone" },
    { projectId: proj("Route Optimisation Engine Deployment").id, month: "2024-11", recognisedAmount: "80000",  method: "milestone" },
    { projectId: proj("Route Optimisation Engine Deployment").id, month: "2024-12", recognisedAmount: "116000", method: "milestone" },
    { projectId: proj("Route Optimisation Engine Deployment").id, month: "2025-01", recognisedAmount: "120000", method: "time_and_materials" },
    { projectId: proj("Route Optimisation Engine Deployment").id, month: "2025-02", recognisedAmount: "90000",  method: "time_and_materials" },
    { projectId: proj("Route Optimisation Engine Deployment").id, month: "2025-03", recognisedAmount: "84000",  method: "milestone", notes: "Final retention" },
    { projectId: proj("HarbourLink EDI Integration").id,          month: "2025-03", recognisedAmount: "28000",  method: "time_and_materials" },
    { projectId: proj("HarbourLink EDI Integration").id,          month: "2025-04", recognisedAmount: "36000",  method: "time_and_materials" },
  ]);
